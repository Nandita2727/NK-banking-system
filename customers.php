...
.customer-11 .container .details-button {
border-radius: 4px;
background-color: #333;
border: none;
color: #FFFFFF;
...
.customer-11 .container .details-button .details-button-span {
cursor: pointer;
display: inline-block;
position: relative;
transition: 0.5s;
...
.customer-11 .container .details-button .details-button-span:after {
content: '\203A';
position: absolute;
opacity: 0;
top: 0;
...
.customer-11 .container .details-button:hover .details-button-span {
padding-right: 15px;
}

.customer-11 .container .details-button:hover .details-button-span:after {
opacity: 1;
right: 0;
}

.customer-11 .container .transact-details-button {
border-radius: 4px;
background-color: #333;
border: none;
color: #FFFFFF;
...
.customer-11 .container .transact-details-button .transact-details-button-span {
cursor: pointer;
display: inline-block;
position: relative;
transition: 0.5s;
...
.customer-11 .container .transact-details-button .transact-details-button-span:after {
content: '\203A';
position: absolute;
opacity: 0;
top: 0;
...
.customer-11 .container .transact-details-button:hover .transact-details-button-span {
padding-right: 15px;
}

.customer-11 .container .transact-details-button:hover .transact-details-button-span:after {
opacity: 1;
right: 0;
}

.customer-11 .container .details-customer-11 {
display: none; 
position: fixed;
z-index: 9999; 
padding-top: 100px; 
...
.customer-11 .container .details-customer-11 .details-customer-11-content {
background-color: peachpuff;
margin: auto;
padding: 20px;
border-radius: 25px;
...
.customer-11 .container .details-customer-11 .details-customer-11-content .close {
color: #666;
float: right;
font-size: 45px;
font-weight: bold;
...
.customer-11 .container .details-customer-11 .details-customer-11-content .close:hover, 
.customer-11 .container .details-customer-11 .details-customer-11-content .close:focus {
color: #000;
transform: scale(1.1);
text-decoration: none;
cursor: pointer;
...
.customer-11 .container .details-customer-11 .details-customer-11-content p {
font-size: 25px;
font-weight: 800;
text-align: justify;
position: relative;
...
.customer-11 .container .details-customer-11 .details-customer-11-content p span {
font-weight: 600;
font-family: monospace;
}

.customer-11 .container .details-customer-11 .details-customer-11-content .transact-button {
border-radius: 4px;
background-color: #333;
border: none;
color: #FFFFFF;
...
.customer-11 .container .details-customer-11 .details-customer-11-content .transact-button:hover {
transform: scale(1.1);
letter-spacing: 1.5px;
}

.customer-11 .container .details-customer-11 .details-customer-11-content .passbook-button {
border-radius: 4px;
background-color: #333;
border: none;
color: #FFFFFF;
...
.customer-11 .container .details-customer-11 .details-customer-11-content .passbook-button:hover {
transform: scale(1.1);
width: 200px;
letter-spacing: 1.5px;
}
...
.customer-12 .container .details-button {
border-radius: 4px;
background-color: #333;
border: none;
color: #FFFFFF;
...
.customer-12 .container .details-button .details-button-span {
cursor: pointer;
display: inline-block;
position: relative;
transition: 0.5s;
...
.customer-12 .container .details-button .details-button-span:after {
content: '\203A';
position: absolute;
opacity: 0;
top: 0;
...
.customer-12 .container .details-button:hover .details-button-span {
padding-right: 15px;
}

.customer-12 .container .details-button:hover .details-button-span:after {
opacity: 1;
right: 0;
}

.customer-12 .container .transact-details-button {
border-radius: 4px;
background-color: #333;
border: none;
color: #FFFFFF;
...
.customer-12 .container .transact-details-button .transact-details-button-span {
cursor: pointer;
display: inline-block;
position: relative;
transition: 0.5s;
...
.customer-12 .container .transact-details-button .transact-details-button-span:after {
content: '\203A';
position: absolute;
opacity: 0;
top: 0;
...
.customer-12 .container .transact-details-button:hover .transact-details-button-span {
padding-right: 15px;
}

.customer-12 .container .transact-details-button:hover .transact-details-button-span:after {
opacity: 1;
right: 0;
}

.customer-12 .container .details-customer-12 {
display: none; 
position: fixed;
z-index: 9999; 
padding-top: 100px; 
...
.customer-12 .container .details-customer-12 .details-customer-12-content {
background-color: peachpuff;
margin: auto;
padding: 20px;
border-radius: 25px;
...
.customer-12 .container .details-customer-12 .details-customer-12-content .close {
color: #666;
float: right;
font-size: 45px;
font-weight: bold;
...
.customer-12 .container .details-customer-12 .details-customer-12-content .close:hover, 
.customer-12 .container .details-customer-12 .details-customer-12-content .close:focus {
color: #000;
transform: scale(1.1);
text-decoration: none;
cursor: pointer;
...
.customer-12 .container .details-customer-12 .details-customer-12-content p {
font-size: 25px;
font-weight: 800;
text-align: justify;
position: relative;
...
.customer-12 .container .details-customer-12 .details-customer-12-content p span {
font-weight: 600;
font-family: monospace;
}

.customer-12 .container .details-customer-12 .details-customer-12-content .transact-button {
border-radius: 4px;
background-color: #333;
border: none;
color: #FFFFFF;
...
.customer-12 .container .details-customer-12 .details-customer-12-content .transact-button:hover {
transform: scale(1.1);
letter-spacing: 1.5px;
}

.customer-12 .container .details-customer-12 .details-customer-12-content .passbook-button {
border-radius: 4px;
background-color: #333;
border: none;
color: #FFFFFF;
...
.customer-12 .container .details-customer-12 .details-customer-12-content .passbook-button:hover {
transform: scale(1.1);
width: 200px;
letter-spacing: 1.5px;
}
...
@media (max-width: 420px) {
    ...
    .customer-11 .container .details-customer-11 .details-customer-1-content p {
        font-size: 18px;
        left: 5%;
    }

    .customer-12 .container .details-customer-12 .details-customer-1-content p {
        font-size: 18px;
        left: 5%;
    }
...
<section class="page-header">
    <div class="header">
        <div class="header-left"> 
            <img src="images/logo 1.jpg" class="header-left-logo">
        </div>    
...
<section class="page-footer">
    ...
    <div class="footer-bottom">
        <p class="footer-content">Designed & Developed with <i class="fa fa-clock-o" style="color: red;"></i> by <a href="devloper.html">Nandita kharatmal</a></p>
    </div>
</section>
</body>
</html> 
